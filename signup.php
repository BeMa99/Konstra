...
<input name = "password1" type = "password" size = "20" placeholder = "Enter Password" style = "margin-top:15px; margin-bottom:30px;" required/></br>
<input name = "password2" type = "password" size = "20" placeholder = "Confirm Password" style = "margin-top:15px; margin-bottom:30px;" required/></br>
